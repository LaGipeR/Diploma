    ...
    Dist: FnOnce(f64) -> f64 + Copy,
{
    ...
    */
    ...
    // println!("{t_z}\t{:?}\t{:?}", main_elements_time, repair_elements_time);
    ...
    if t + theta > t_z {
        ...
        // print!("\twork_cnt {working_main_elements_cnt}\t");
        return if working_main_elements_cnt >= min_main_elements_for_work {
            // print!("0\n");
            0.0
        } else {
            // print!("1\n");
...
fn calc(
    ...
    // println!("less_tz {less_tz_probability}");
        ...
        */
        ...
        for main_elements_cnt_less_tz_in_cur_case in 0..=main_cnt {
            ...
            if main_elements_cnt_less_tz_in_cur_case < main_cnt {
                ...
                case_probability = if main_cnt == main_elements_cnt_less_tz_in_cur_case + 1 {less_tz_probability.powi(main_cnt.try_into().unwrap())} else {0.0};
...
fn main() {
    let params = [
        (100_000, 1.0, 5.0, 100.0, 2, 3, 3, 1),             // 0.00006645619793814148
